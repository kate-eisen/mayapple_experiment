...
a<-emmip(s_t1mod1, Sever~Status  ,CIs = TRUE,linearg = list(linetype = NA))+ ylab("Total leaf area (cm^2)")+ 
...
b<-emmip(s_t1mod2, Sever~Status  ,CIs = TRUE, linearg = list(linetype = NA))+ ylab("Average leaf area per system (cm^2)")+ xlab("Number of descendant rhizome systems") +
